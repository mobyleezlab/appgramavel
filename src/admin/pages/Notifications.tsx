...
// ---------- KPI ----------
function KpiCard({ title, value, suffix, delta, icon: Icon }: {
  title: string; value: string | number; suffix?: string; delta?: number | null; icon: any;
}) {
  const isUp = (delta ?? 0) > 0, isDown = (delta ?? 0) < 0;
  return (
    <Card>
